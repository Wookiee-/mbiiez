...
Testing new changes to run this under user other than through root as a security risk. I've updated the installer also with the changes.
...
4. Added a Pre-CTF installer before 1.9 for those who don't want the CTF
