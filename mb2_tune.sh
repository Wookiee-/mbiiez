...
# Append to limits.conf to make it permanent for the user
echo "mbiiez soft nofile 65536" | sudo tee -a /etc/security/limits.conf
echo "mbiiez hard nofile 65536" | sudo tee -a /etc/security/limits.conf
